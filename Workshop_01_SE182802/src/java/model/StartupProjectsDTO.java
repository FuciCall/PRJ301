...
public class StartupProjectsDTO {
    ...
    private int estimated_launch;

    
    public StartupProjectsDTO() {
    }
    
    public StartupProjectsDTO(int project_id, String project_name, String description, String status, int estimated_launch) {
    ...
    public int getEstimated_launch() {
        return estimated_launch;
    }

    public void setEstimated_launch(int estimated_launch) {
        this.estimated_launch = estimated_launch;
    }
