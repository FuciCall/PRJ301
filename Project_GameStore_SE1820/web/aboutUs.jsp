...
<body>
    ...
    <div class="container">
        ...
        <div class="founders">
            <div class="founder">
                <img src="images/long.jpg" alt="Le Hoang Long">
                <p>Le Hoang Long (K18)</p>
            </div>
            <div class="founder">
                <img src="https://www.bing.com/images/blob?bcid=r2.XWG75Vh0IaA" alt="Dang Hoang Phuc">
                <p>Dang Hoang Phuc (K18)</p>
            </div>
            <div class="founder">
                <img src="images/huy.jpg" alt="Le Nguyen Diep Huy">
